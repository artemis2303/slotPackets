...
{	
	...
	{	
		...
		fields = ["type", "spinData", "errorCode", "userId", "balance", "totalWin", "reels", "indexOfBetPerLine", "numLines", "unknown7", "unknown8", "unknown9", "unknown10", "unknown11", "unknown12", "winPerLine", "unknown14", "gambleHistory"];
