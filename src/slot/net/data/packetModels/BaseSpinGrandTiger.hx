...
class BaseSpinGrandTiger extends BasePacketData 
{	
	...
	{	
		...
		fields = ["type", "spinData", "errorCode", "userId", "balance", "totalWin", "reels", "indexOfBetPerLine", "numLines", "bonusSpinsTotal", "bonusSpinsLeft", "bonusSpinWin", "bonusGameMultiplayer", "unknown11", "bonusSpinWinTotal", "bonusGameReels", "winPerLine", "gambleHistory", "unknown12"];
		types = ["single", "double", "single", "int", "int", "int", "arrayData2", "double", "double", "int", "int", "int", "int", "int", "int", "arrayData2", "arrayDoubleInt", "array8Double", "array5Double"];
	}
	
	override public function toString():String
	{
		return "[BaseSpinGrandTiger\n type=" + type + "\n spinData=" + spinData + "\n errorCode=" + errorCode + "\n userId=" + userId + "\n balance=" + balance + "\n totalWin=" + totalWin + "\n reels=" + reels + "\n indexOfBetPerLine=" + indexOfBetPerLine + "\n numLines=" + numLines + "\n bonusSpinsTotal=" + bonusSpinsTotal + "\n bonusSpinsLeft=" + bonusSpinsLeft + "\n bonusSpinWin=" + bonusSpinWin + "\n bonusGameMultiplayer=" + bonusGameMultiplayer + "\n unknown11=" + unknown11 + "\n bonusSpinWinTotal=" + bonusSpinWinTotal + "\n bonusGameReels=" + bonusGameReels + "\n winPerLine=" + winPerLine + "\n gambleHistory=" + gambleHistory + "\n unknown12=" + unknown12 + ")]";
	}
}